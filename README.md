...
أضف `GROQ_API_KEY` إلى ملف `.env` وRender لتفعيل إعادة ترتيب المرشحين عند البحث فقط. يبقى الجنس وبقية الفلاتر الأساسية مفروضة في الكود، ولا تُرسل الأسماء الحقيقية أو معرفات تيليغرام أو الرسائل إلى Groq.
